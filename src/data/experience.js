    ...
    projects: [
      {
        ...
        points: [
          ...
          'Cut manual processing time by 30% by designing and shipping REST APIs and backend services in Node.js and Express.js that automated contract-decision workflows end to end.',
      ...
      },
      {
        ...
        points: [
          ...
          'Built automated data-validation and sanity checks that enforced business rules before load, cutting manual data-processing effort by 35% and keeping data consistent across refreshes.',
        ],
      },
    ],
  },
